...
class TestFAQ:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                    ...
                    "Отсчёт времени аренды начинается с момента, когда вы оплатите "
                    "заказ курьеру. Если мы привезли самокат 8 мая в 20:30, "
            ...
            (
                    "Я жизу за МКАДом, привезёте?", # Ошибка на сайте должно быть "живу"
    ...
    def test_faq_questions(self, driver, question, expected_answer):
        ...
        assert faq_page.is_question_expanded(question)
        assert faq_page.is_answer_visible(question)
